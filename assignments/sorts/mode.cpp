...
int main(){
    std::vector <int> test = {5,10,3,2,2,1,5,6,8,10,10,18,18,3,2};
    std::cout<<"Test Vector 1: "<<"\n";
    print_vector(test);
    std::vector<int> test2 = {8,8,8,8,8,8,8};
    std::cout<<"Test Vector 2: "<<"\n";
    print_vector(test2);
    std::vector<int> test3 = {1,1,1,3,3,3,3};
    std::cout<<"Test Vector 3: "<<"\n";
    print_vector(test3);
    std::cout<<"Number of 2s in Test 1: "<<count(test,2)<<"\n";
    std::cout<<"Number of 10s in Test 1: "<<count(test,10)<<"\n";
    std::cout<<"Number of 15s in Test 1: "<<count(test,15)<<"\n";
    std::cout<<"Number of 8s in Test 2: "<<count(test2,8)<<"\n";
    std::cout<<"Number of 10s in Test 2: "<<count(test2,10)<<"\n";
    std::cout<<"Number of 1s in Test 3: "<<count(test3,1)<<"\n";
    std::cout<<"Number of 3s in Test 3: "<<count(test3,3)<<"\n";
